...
const Hero = () => {
  return (
    ...
    >
        ...
        font-medium bg-gradient-to-t from-slate-200 via-gray-300 to-slate-50 bg-clip-text text-transparent" > Lead Canada’s <br/>
        <span  className="bg-gradient-to-r from-yellow-300 via-amber-400 to-yellow-600 bg-clip-text text-transparent">
          ...
          <br/> <span className='bg-gradient-to-t from-slate-200 via-gray-300 to-slate-50 bg-clip-text text-transparent'>with Stell Maris</span>
        </motion.h1>
        <motion.p 
        ...
        className="text-sm sm:text-lg font-medium text-gray-500
         dark:text-white/75 pb-3 disclaimer"> Stell Maris is the E-Commerce Accelerator built for <strong>growing</strong> global brands entering the booming Canadian market
        </motion.p>
