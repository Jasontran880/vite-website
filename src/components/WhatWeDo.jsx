...
const WhatWeDo = () => {
  ...
  return (
    <div id="WhatWeDo" className="py-20 min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-x-50 gap-y-10 max-w-7xl mx-auto px-8 w-full justify-items-center">
          <GlareCard className="flex flex-col items-start justify-center px-10 ">
            ...
            <p className=" mt-15  text-md sm:text-xl md:text-2xl font-medium bg-clip-text ">From Amazon to Walmart, expand your brand across Canada's E-commerce horizon with our cutting edge strategies -- all powered by our equitable partnership model where we invest in your growth.</p>
          </GlareCard>
